...
<결과>  
Accuracy  
<img width="690" alt="스크린샷 2023-12-06 오후 6 50 31" src="https://github.com/haleeseung/Alzheimer-s-disease-diagnosis_Project/assets/127108173/1777c21b-29cb-4655-97eb-5e8b39bd1ca7">  
  
Loss  
<img width="681" alt="스크린샷 2023-12-06 오후 6 50 41" src="https://github.com/haleeseung/Alzheimer-s-disease-diagnosis_Project/assets/127108173/40e1417b-665e-46ae-9a0a-cdc4e78afea0">  
 
확실히 이전에 했던 것에 비하면 성능이 향상된 것을 확인할 수 있습니다. ResNet50을 이용하였을 때 성능이 가장 좋게 나왔습니다. 다른 모델인 Densenet을 사용할 예정이고, ResNet50과 비교하여 둘 중 더 성능이 높은 모델의 하이퍼 파라미터를 튜닝할 계획입니다.

### 12/14
- 12월 17일까지 기말고사 제출로 인하여, Record 작성은 12/14의 데이터 파일까지만 기록을 하였고, 12/14에 올린 데이터 파일에 대한 학습 결과 및 성능 확인은 기말고사 제출용 ppt와 보고서를 통해 더욱 명백히 확인할 수 있습니다.
